...
resource "aws_vpc_security_group_ingress_rule" "allow_market_app_server_http_ipv4" {
  security_group_id = aws_security_group.market_app_server_sg.id
  cidr_ipv4         = "0.0.0.0/0"
  from_port         = 80
  ip_protocol       = "tcp"
...
resource "aws_vpc_security_group_ingress_rule" "allow_market_app_server_https_ipv4" {
  security_group_id = aws_security_group.market_app_server_sg.id
  cidr_ipv4         = "0.0.0.0/0"
  from_port         = 443
  ip_protocol       = "tcp"
